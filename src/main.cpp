...
#if defined(NDEBUG)
# error "FolgoryCoin cannot be compiled without assertions."
#endif
...
int nStakeMinConfirmations = 480;
...
const string strMessageMagic = "FolgoryCoin Signed Message:\n";
...
{
    RenameThread("folgorycoin-loadblk");
